...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color:white ;color:black ; font-size: 17px; font-family:Times ">
        ...
        <div class="col-xs-12">
          <div class="box"style="background-color: #00A9FF;">
            <div class="box-header with-border"style="background-color: #00A9FF">
              <a href="#reset" data-toggle="modal" class="btn btn-danger btn-sm btn-curve"  style="background-color:red;color:white ; font-size: 12px; font-family:Times"><i class="fa fa-refresh"></i> Reset</a>
            </div>
            <div class="box-body">
